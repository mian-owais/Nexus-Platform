...
export const updateUserProfile = async (req, res) => {
    try {
        ...
        const user = await User.findByIdAndUpdate(userId, { name, bio, avatarUrl }, { new: true, runValidators: true });
        if (!user) {
            res.status(404).json({
                success: false,
                message: 'User not found',
...
export const updateEntrepreneurProfile = async (req, res) => {
    try {
        ...
        const updatedProfile = await EntrepreneurProfile.findByIdAndUpdate(entrepreneurId, {
            startupName,
            pitchSummary,
            fundingNeeded,
            industry,
...
export const updateInvestorProfile = async (req, res) => {
    try {
        ...
        const updatedProfile = await InvestorProfile.findByIdAndUpdate(investorId, {
            investmentInterests,
            investmentStage,
            minimumInvestment,
            maximumInvestment,
