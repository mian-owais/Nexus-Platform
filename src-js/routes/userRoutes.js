...
import { getUserProfile, updateUserProfile, updateEntrepreneurProfile, updateInvestorProfile, getAllEntrepreneurs, getAllInvestors, } from '../controllers/userController';
const router = Router();
 ...
 * @access  Private
 */
router.put('/profile/entrepreneur/:entrepreneurId', authenticate, updateEntrepreneurValidation, updateEntrepreneurProfile);
/**
 * @route   PUT /api/profile/investor/:investorId
 * @desc    Update investor profile
 * @access  Private
 */
router.put('/profile/investor/:investorId', authenticate, updateInvestorValidation, updateInvestorProfile);
/**
