...
import { scheduleMeeting, getUserMeetings, getMeetingById, acceptMeeting, declineMeeting, updateMeeting, cancelMeeting, completeMeeting, getAvailableSlots, } from '../controllers/meetingController';
const router = Router();
