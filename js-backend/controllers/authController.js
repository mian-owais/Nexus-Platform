...
const register = async (req, res) => {
    try {
        ...
        if (role === 'entrepreneur') {
            const entrepreneurProfile = new EntrepreneurProfile_1.EntrepreneurProfile({
                userId: user._id,
                startupName: '',
                pitchSummary: '',
                fundingNeeded: '',
            ...
            const investorProfile = new InvestorProfile_1.InvestorProfile({
                userId: user._id,
                investmentInterests: [],
                investmentStage: [],
                portfolioCompanies: [],
        ...
        // Generate tokens
        const token = (0, jwt_1.generateToken)(user._id.toString(), role);
